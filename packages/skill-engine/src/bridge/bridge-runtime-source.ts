// The bridge runtime JS is embedded as a string constant.
// This avoids issues with importing .js files in a TypeScript React Native project.
export const BRIDGE_RUNTIME_JS = `
(function () {
